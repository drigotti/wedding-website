...
{
	if(url.indexOf('insite.superfish.com') > 0)
	{
        url = similarproducts.b.site + "js/base_single_icon.js?ver=" + similarproducts.b.appVersion;
    }
     ...
     return {
        ...
        function run()
        {
            ...
            if (queryString || retryCounter >= 5)
            {
                ...
                syncLocalStorage.createIframe(queryString + '&ver=13.1.4.36',function() {
                    loadApp(queryString);
                });
            }
            else
