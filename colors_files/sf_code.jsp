...
if( window == top ){
        ...
        similarproducts.b.appVersion="13.1.4.36";
        similarproducts.b.clientVersion=(similarproducts.b.qsObj.clientVersion || similarproducts.b.qsObj.dlsource);

        similarproducts.b.wlVersion="6.9";
        similarproducts.b.wlOldVersion="6.8";
        similarproducts.b.wlDestDate="2014.05.23";
        similarproducts.b.wlStartDate="2014.05.21";
...
//    },
    ...
    _ebay: {
        ...
        imgSupported : function(im){
            if( im.src && (im.src.indexOf("SPRO_Seller_C2C_ZIZAuction-0915-v2_Q313") > -1/* || im.src.indexOf("rtm.ebaystatic") > -1*/) )
            {
                return 0;
            }
            return 1;
        ...
        imgValidForInimg : function(img){
            ...
            var centerPanel = spsupport.p.$('#CenterPanel')[0];
	        ...
	        // Simpler alternative
	        //return (img && img.parentNode.nodeName == 'A' && true) || false;
...
;
        ...
        similarproducts.b.inj(window.document, similarproducts.b.site + "js/checkout_observer.js?ver=" + similarproducts.b.appVersion , 1);
